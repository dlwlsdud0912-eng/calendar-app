...
const CAT_MESSAGES = [
  ...
  '오늘 계약 두 건 연속으로 터진다!',
  '오늘 서류 한 방에 깔끔하게 끝난다!',
  '오늘 전화 한 통이 인생 거래로 이어진다!',
  '블로그 보고 연락 온다, 오늘!',
  '소개 손님이 줄줄이 들어오는 날!',
  '"사장님 덕분에 좋은 집 구했어요" 듣는 날!',
  '까다로운 손님도 오늘은 OK 한다!',
  '오늘 만나는 손님, 즉시 계약 의사 있음!',
  '네이버 부동산 문의 폭주하는 날!',
  '단골 손님이 지인 소개해준다!',
  '이번 달 목표 매출, 오늘 달성!',
  '오늘 받는 중개보수로 맛있는 거 먹자!',
  '올해 최고 수수료 거래, 오늘 시작된다!',
  '발품 판 만큼 반드시 돌아온다, 오늘!',
  '현장에 답이 있다 — 오늘 나가면 잡는다!',
  '어제의 고생이 오늘의 계약으로 보답받는다!',
  '오늘 하루, 부동산의 신이 함께한다!',
  '힘들었지? 오늘은 좋은 일만 생긴다!',
  '공인중개사 한 지 잘했다 느끼는 날!',
  '오늘의 운세: ★★★★★ 계약운 최고!',
  '당신이 이 동네 최고 중개사입니다!',
  '포기하지 않은 당신, 오늘 결실 맺는다!',
  '지금 이 자리까지 온 것만으로 대단해!',
  '매일 성실한 당신, 손님들이 다 알고 있어!',
  '당신의 상담 한마디가 누군가의 인생을 바꾼다!',
  '오늘도 사무실 문 여는 당신이 멋있다!',
  '안 되는 날도 버텨온 당신, 진짜 프로!',
  '당신 같은 중개사 만난 손님은 복 받은 거야!',
  '꾸준히 해온 당신, 곧 터질 차례야!',
  '힘든 만큼 단단해졌다, 당신은 이미 충분해!',
  '매물 정리하는 그 성실함, 반드시 보상받는다!',
  '오늘 하루도 최선을 다하는 당신, 응원합니다!',
];
