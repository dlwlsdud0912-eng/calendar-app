...
■ 고객 관련 일정
  "김정은 중도금2차" → 고객명: 김정은, 내용: 중도금 2차
  "전용호 잔금" → 고객명: 전용호, 내용: 잔금
...
### 일정 추가 (create)
{"action":"create","events":[{"title":"일정제목","eventDate":"YYYY-MM-DD","eventEndDate":"YYYY-MM-DD 또는 null","eventTime":"HH:MM 또는 null","eventType":"안내|계약|중도금1차|중도금2차|중도금3차|중도금4차|잔금|상담|일상","amount":null,"customerName":"고객명 또는 null","memo":"추가정보 또는 null"}]}
